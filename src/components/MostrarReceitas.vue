...
import checkListas from '@/operacoes/listas';
...
export default {
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas.filter((receita)=>{
      return checkListas(receita.ingredientes, this.ingredientes)
    });
  },
...
<template>
  <section class="mostrar-receitas">
    ...
    <BotaoPrincipal texto="Editar lista" @click="$emit('AlterarTela')" />
  </section>
</template>
