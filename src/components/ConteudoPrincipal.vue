...
export default {
  components: { SelecionarIngredientes, Tag, SuaListaVue, MostrarReceitas },
  data() {
    return {
  ...
  methods: {
    ...
    alterarTela() {
      if (this.conteudo === 'SelecionarIngredientes')
  ...
  <main class="conteudo-principal">
    ...
    <KeepAlive include="SelecionarIngredientes">
      <SelecionarIngredientes v-if="conteudo === 'SelecionarIngredientes'" @adicionar-ingrediente="adicionarIngrediente"
        @remover-ingrediente="removerIngrediente($event)" @alterar-tela="alterarTela" />

      <MostrarReceitas v-else-if="conteudo === 'MostrarReceitas'"
        :ingredientes="ingredientes"
       @alterar-tela="alterarTela" />
    </KeepAlive>
  </main>
</template>
